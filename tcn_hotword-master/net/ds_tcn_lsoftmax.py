...
class DS_TCN_LSoftMax(nn.Module):
    def __init__(self, channels, kernels, dilations, num_classes, residual=False,
        ...
        self.dense = LSoftmaxLinear(channels[-1], num_classes, 2, self.device)
...
def test():
    ...
    dilations = [1, 2, 4, 4, 8]
    num_classes = 9
    net = DS_TCN_LSoftMax(channels, kernels, dilations, num_classes, device='cpu')
