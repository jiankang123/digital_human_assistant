...
def load_label_and_score(keyword, label_file, score_file, hotword_dict):
...
if __name__ == '__main__':
    ...
    keyword_table, filler_table, filler_duration = load_label_and_score(
        keyword, test_data, score_file, hotword_dict)
    ...
    with open(stats_file, 'w', encoding='utf8') as fout:
        ...
        while threshold <= 1.0:
            ...
            fout.write('{:.6f} {:.6f} {:.6f}\n'.format(threshold,false_alarm_per_hour,false_reject_rate))
            threshold += step
