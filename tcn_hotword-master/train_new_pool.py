...
# def save_pt(net, epoch, val_correct, val_loss, val_FAR, test_correct, test_loss, test_FAR, top_corrects, output_dir):
#     top_corrects.append([epoch, val_correct, val_loss, val_FAR, test_correct, test_loss, test_FAR])
#     ptfile = os.path.join(output_dir, "epoch{}.pt".format(epoch))
